...
# Especificar la ubicación del archivo .env
...
SECRET_KEY = os.environ.get('SECRET_KEY','sin-definir')
print(SECRET_KEY)
...
DATABASE_NAME = os.environ.get('DATABASE_NAME','db-sin-definir.sqlite3')
print(DATABASE_NAME)
